![GitHub release (latest by date)](https://img.shields.io/github/v/release/zscaler/terraform-modules-zscaler-ci-workflows?style=flat-square)
![GitHub](https://img.shields.io/github/license/zscaler/terraform-modules-zscaler-ci-workflows?style=flat-square)
...
* [terraform-aws-zpa-private-service-edge-modules](https://github.com/zscaler/terraform-aws-zpa-private-service-edge-modules)
* [terraform-aws-zpa-app-connector-modules](https://github.com/zscaler/terraform-aws-zpa-app-connector-modules)
* [terraform-azurerm-zpa-app-connector-modules](https://github.com/zscaler/terraform-azurerm-zpa-app-connector-modules)
* [terraform-azurerm-zpa-private-service-edge-modules](https://github.com/zscaler/terraform-azurerm-zpa-private-service-edge-modules)
...
jobs:
  lint_pr_title:
    name: Lint PR
    uses: zscaler/terraform-modules-zscaler-ci-workflows/.github/workflows/lint_pr_title.yml@v0
```
